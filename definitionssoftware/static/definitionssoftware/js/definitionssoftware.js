// Expand and collapse all term & definition elements.

function defiExpand() {
    $("details").attr("open","");
}

function defiCollapse() {
    $("details").removeAttr("open");
}


// This javascript Ajax functionality is based on this tutorial: 'How to Implement CRUD Using Ajax and Json'
